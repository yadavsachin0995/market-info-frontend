...
To run the container in detached mode, use -d.
```
...
![alt text](https://github.com/yadavsachin0995/market-info-frontend/blob/main/snapshots/screen1.PNG?raw=true)

Filter text entered inside textbox provides real-time filtering of results
![alt text](https://github.com/yadavsachin0995/market-info-frontend/blob/main/snapshots/screen2.PNG?raw=true)

If a user clicks download button on filtered results screen, only present records are downloaded in csv
![alt text](https://github.com/yadavsachin0995/market-info-frontend/blob/main/snapshots/screen3.PNG?raw=true)

Information of containers used to run the app along with port numbers
![alt text](https://github.com/yadavsachin0995/market-info-frontend/blob/main/snapshots/screen4.PNG?raw=true)
